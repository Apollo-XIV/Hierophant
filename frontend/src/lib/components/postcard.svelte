...
<component bind:this={component} on:focus={hover} on:mouseover={hover} on:mouseleave={leave} on:focusout={leave} tabindex="0" id="frame" on:keydown={(e) => {if(e.key == 'Enter') {goto('/posts')}}}  on:click={() => goto('/posts')} >
