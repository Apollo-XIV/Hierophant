  ...
  function validate(module, file) {
    ...
    for (const key in module) {
      if (key[0] === "_" || set.has(key))
        continue;
      const hint = hint_for_supported_files(key, file?.slice(file.lastIndexOf("."))) ?? `valid exports are ${expected.join(", ")}, or anything with a '_' prefix`;
...
export {
  ...
  HttpError as H,
  Redirect as R,
  escape_html_attr as a,
  add_data_suffix as b,
  ...
  decode_params as i,
  json as j,
  validate_page_server_exports as k,
  validate_server_exports as l,
  make_trackable as m,
  normalize_path as n,
  get_route_segments as o,
  decode_uri as p,
  is_root_relative as q,
  resolve as r,
  strip_data_suffix as s,
  text as t,
  validate_common_exports as v
};
